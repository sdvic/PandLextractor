...
//		    System.out.println("right echo received = " + distance);
...
//	});
	...
	{
	    System.out.println(" Strobe R");
	    rightStrobe.low();
	    rightStrobe.high();
	    rightStrobe.low();
	    return rightFilteredDistance;
	}
	if (position.equals(" Strobe L"))
	{
	    leftStrobe.low();
	    leftStrobe.high();
	    leftStrobe.low();
